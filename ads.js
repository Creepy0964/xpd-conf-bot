...
bot.onText(/\/start/, (msg) => {
    bot.sendMessage(msg.chat.id, `Добро пожаловать в бота XPD Forum! Чтобы отправить тейк, напишите сюда его. К отправке принимаются: текст, видео, фото, аудио, голосовые сообщения.`);
});
